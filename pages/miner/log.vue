<template>
	<view class="content">
		<view class="tables">
			...
			<view class="lis"  :class="{ active: isActive === 1 }"  @click="setActive(1)">进行中</view>
		...
		<view class="loglist" v-if="list.length>0">
			<view class="lis" v-for="(item,index) in list" :key="index">
				<view class="ts"><view  class="tl">{{item.package_name}}：{{item.id}}</view><view class="tr">兑换时间:{{item.create_time}}</view></view>
				<view class="mkl">
					<view class="mkls">
						<view class="mkts">{{item.day}}天</view>
						<view class="mktt">剩余时间</view>
					</view>
					<view class="mkls">
						<view class="mkts">{{item.last_reward}}</view>
						<view class="mktt">剩余金币</view>
					</view>
					<view class="mkls">
						<view class="mkts">{{item.acc_reward}}</view>
						<view class="mktt">已获得金币</view>
					</view>
				</view>
			</view>
		</view>
