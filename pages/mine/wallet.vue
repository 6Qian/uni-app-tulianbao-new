<template>
	<view class="content">
		...
		<view class="top">
			...
			<view style="display: flex; justify-content: flex-start; align-items: center; margin-top: 48rpx;">
				<image class="hoow" style="padding: 0; width: 164rpx; height: 63rpx;" @click="ToGiveaway()" src="/static/zs.png" mode=""></image>
				<text  @click="ToGiveaway(type=2)"  style="margin-left: 20rpx; width: 164rpx; text-align: center; line-height: 63rpx; border-radius: 60rpx; height: 63rpx; font-size: 28rpx; background: #ffede9; color: #fc9164;" >兑换金豆</text>
			</view>
